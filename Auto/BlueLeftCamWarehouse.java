//Blue side, drops block and parks in warehouse
...
@Autonomous(name="BlueLeftCamWarehouse") //USE STINKY PRESET, SET SO RIGHT WHEELS ARE ON SECOND LINE

public class BlueLeftCamWarehouse extends LinearOpMode{
