//red side, drops block, parks in storage. We were having an issue where the carousel was ramping up in speed on this auton (and not stopping) and maybe one of the others. Not sure the reason why
...
@Autonomous(name="RedLeftCamStorage") //USE STINKY PRESET, SET SO RIGHT WHEELS ARE ON SECOND LINE

public class RedLeftCamStorage extends LinearOpMode{
